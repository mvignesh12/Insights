...
public interface ConfigOptions {
	...
	String CONFIG_FILE_RESOLVED_PATH = "/usr/INSIGHTS_HOME" + FILE_SEPERATOR + ConfigOptions.CONFIG_DIR + FILE_SEPERATOR + ConfigOptions.CONFIG_FILE;
	String CORRELATION_FILE_RESOLVED_PATH = "/usr/INSIGHTS_HOME" + FILE_SEPERATOR + ConfigOptions.CONFIG_DIR + FILE_SEPERATOR + ConfigOptions.CORRELATION_TEMPLATE;
	...
	String DATA_ENRICHMENT_FILE_RESOLVED_PATH = "/usr/INSIGHTS_HOME" + FILE_SEPERATOR + ConfigOptions.CONFIG_DIR + FILE_SEPERATOR + ConfigOptions.DATA_ENRICHMENT_TEMPLATE;
	String FAILURE_RESPONSE = "FAILURE";
	String SUCCESS_RESPONSE = "SUCCESS";
	String CONFIG_FILE_DIR = "/usr/INSIGHTS_HOME" + FILE_SEPERATOR + ConfigOptions.CONFIG_DIR;
